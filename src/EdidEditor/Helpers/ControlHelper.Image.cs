...
namespace EdidEditor.Helpers
{
    public partial class ControlHelper
    {
        ...
        public static readonly DependencyProperty ImageNormalProperty = DependencyProperty.RegisterAttached(
            "ImageNormal", typeof(ImageSource), typeof(ControlHelper), new PropertyMetadata(default(ImageSource)));
        ...
        public static readonly DependencyProperty ImageCheckedProperty = DependencyProperty.RegisterAttached(
            "ImageChecked", typeof(ImageSource), typeof(ControlHelper), new PropertyMetadata(default(ImageSource)));
        ...
        public static readonly DependencyProperty ImageDisableProperty = DependencyProperty.RegisterAttached(
            "ImageDisable", typeof(ImageSource), typeof(ControlHelper), new PropertyMetadata(default(ImageSource)));
