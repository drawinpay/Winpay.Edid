...
namespace Edid.Utils
{
    ...
    public static class ByteDataConverter
    {
        ...
        /// <param name="separators">Separators between each hex byte string.</param>
        /// <returns></returns>
        public static byte[] ParseHexString(this string hexString, string[] separators)
        {
            ...
            var hexStringArray = hexString.Split(separators, StringSplitOptions.RemoveEmptyEntries);
